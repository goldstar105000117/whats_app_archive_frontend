            ...
            <div className="max-w-md w-full space-y-8 p-8">
                <div className="bg-white rounded-lg shadow-xl p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="mt-2 text-gray-600">Access your WhatsApp Archive</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-whatsapp-green focus:border-whatsapp-green"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-whatsapp-green focus:border-whatsapp-green"
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <Link to="/register" className="font-medium text-whatsapp-green hover:text-whatsapp-green-dark">
                                Sign up
                            </Link>
                        </p>
                    </div>
